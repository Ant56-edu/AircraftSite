...
<body>
	...
	<form action="./SignUpCheck" method="post" name="login" id="login">
		<table align="center">
			<tr>
			...
			<tr>
				<td>Account Recovery Email:</td>
				<td><input type="email" name="recovery" maxlength="255" value="" /></td>
			</tr>
			<tr>
				<td>Password:</td>
			...
			<tr>
				...
				<td style="text-align: right;"><input type="button" name="send"
					value="Sign in" onclick="checksend();" /></td>
			</tr>
		</table>
	</form>
